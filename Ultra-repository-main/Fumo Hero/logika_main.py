...
btn_play = GameSprite("Fumo Hero/button_play.png", 192, 80, 0, 360, 132) #transform.scale(image.load("Fumo Hero/button_play.png"), (192, 80))
btn_play_pressed = GameSprite(transform.scale(image.load("Fumo Hero/button_play_pressed.png")), 192, 80, 0, 360, 132) #transform.scale(image.load("Fumo Hero/Button_play_pressed.png"), (192, 80))

btn_exit = GameSprite(transform.scale(image.load("Fumo Hero/button_exit.png")), 192, 80, 0, 360, 132)#transform.scale(image.load("Fumo Hero/button_exit.png"), (192, 80))
btn_exit_pressed = GameSprite(transform.scale(image.load("Fumo Hero/button_exit_pressed.png")), 192, 80, 0, 360, 132)#transform.scale(image.load("Fumo Hero/Button_exit_pressed.png"), (192, 80))

btn_settings = GameSprite(transform.scale(image.load("Fumo Hero/button_play.png")), 192, 92, 0, 360, 132)#transform.scale(image.load("Fumo Hero/Button_settings.png"), (192, 92))
btn_settings_pressed = GameSprite(transform.scale(image.load("Fumo Hero/button_play.png")), 192, 92, 0, 360, 132)#transform.scale(image.load("Fumo Hero/Button_settings_pressed.png"), (192, 92))
